...
In order to support loading of multiple wallets in yotokens-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yotokens.cpp.
...
Changes to yotokens.cpp
----------------------
yotokens.cpp is the entry point into yotokens-qt, and as such, will require some minor modifications to provide hooks for
