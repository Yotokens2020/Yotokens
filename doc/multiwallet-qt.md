...
In order to support loading of multiple wallets in diablo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is diablo.cpp.
...
Changes to diablo.cpp
----------------------
diablo.cpp is the entry point into diablo-qt, and as such, will require some minor modifications to provide hooks for
