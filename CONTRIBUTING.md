Contributing to diablo Core
============================

The diablo Core project operates an open contributor model where anyone is
...
The following applies to code changes to the diablo Core project, and is not to be
confused with overall diablo Network Protocol consensus changes.

Whether a pull request is merged into diablo Core rests with the project merge
...
Patches that change diablo consensus rules are considerably more involved than
...
Where a patch set proposes to change the diablo consensus, it must have been
...
The project leader is the release manager for each diablo Core release.
