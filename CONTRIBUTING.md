Contributing to yotokens Core
============================

The yotokens Core project operates an open contributor model where anyone is
...
The following applies to code changes to the yotokens Core project, and is not to be
confused with overall yotokens Network Protocol consensus changes.

Whether a pull request is merged into yotokens Core rests with the project merge
...
Patches that change yotokens consensus rules are considerably more involved than
...
Where a patch set proposes to change the yotokens consensus, it must have been
...
The project leader is the release manager for each yotokens Core release.
