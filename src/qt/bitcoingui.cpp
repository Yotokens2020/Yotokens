                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("diablo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a diablo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and diablo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About diablo Core"), this);
    aboutAction->setStatusTip(tr("Show information about diablo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for diablo"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your diablo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified diablo addresses"));
    ...
    openAction->setStatusTip(tr("Open a diablo: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the diablo Core help message to get a list with possible diablo command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("diablo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to diablo network", "", count));
}
...
{
    QString strTitle = tr("diablo Core"); // default title
