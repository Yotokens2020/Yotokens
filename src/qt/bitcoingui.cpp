                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("yotokens Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a yotokens address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and yotokens: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About yotokens Core"), this);
    aboutAction->setStatusTip(tr("Show information about yotokens Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for yotokens"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your yotokens addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified yotokens addresses"));
    ...
    openAction->setStatusTip(tr("Open a yotokens: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the yotokens Core help message to get a list with possible yotokens command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("yotokens Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to yotokens network", "", count));
}
...
{
    QString strTitle = tr("yotokens Core"); // default title
