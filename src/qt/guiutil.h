...
/** Utility functions used by the diablo Qt UI.
 */
namespace GUIUtil
{
...
// Render diablo addresses in monospace font
...
// Parse "diablo:" URI into recipient object, return true on successful parsing
